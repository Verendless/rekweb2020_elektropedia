                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <form action="<?= route_to('register') ?>" method="post" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="email" class="form-control form-control-user <?php if (session('errors.email')) : ?>is-invalid<?php endif ?>" value="<?= old('email') ?> " name="email" placeholder="<?= lang('Auth.email') ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class=" col-sm-6">
                                            <input type="password" name="pass_confirm" class="form-control form-control-user  <?php if (session('errors.pass_confirm')) : ?>is-invalid<?php endif ?>" placeholder="<?= lang('Auth.repeatPassword') ?>" autocapitalize="off">
                                        </div>
                                    </div>
